...
#이버전은 원 버전 DICOM 파일을 사용해서 학습시킨것이다.
...
class MyDataGenerator(Sequence):
    ...
    def __data_generation(self, data_temp, data_label_temp):
        ...
        X = np.array(X, dtype='uint8').reshape(-1, self.dim[0], self.dim[1], 1)
...
r50 = Resnet_re(classes=6,dim=(224,224,1))
